    ...
    <div className="min-h-screen bg-white dark:bg-ink-800">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 lg:px-8">
        ...
        >
          ...
          <h1 className="mt-2 text-4xl font-extrabold tracking-tight text-ink-900 dark:text-ink-50 sm:text-5xl">Un plan pour chaque ambition</h1>
          ...
          <div className="mt-8 inline-flex items-center gap-1 rounded-full border border-ink-200 dark:border-ink-700 bg-ink-50 dark:bg-ink-900 p-1">
            <button
              ...
              className={`rounded-full px-5 py-2 text-sm font-semibold transition ${!annual ? 'bg-white dark:bg-ink-800 text-ink-900 dark:text-ink-50 shadow-soft' : 'text-ink-500 dark:text-ink-400'}`}
            >
              {t('pricing.monthly')}
            </button>
            <button
            ...
            return (
              ...
              >
                ...
                <div className="mt-4 flex items-end gap-1">
                  <span className="text-4xl font-extrabold text-ink-900 dark:text-ink-50">${displayPrice}</span>
