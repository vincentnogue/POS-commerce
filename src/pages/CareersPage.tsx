...
export function CareersPage() {
  ...
  return (
    <FooterPageLayout title="Carrières chez LiAfrik">
      ...
      <section className="mt-8">
        ...
        <div className="mt-4 space-y-4">
          ...
          {!loading && jobs.length === 0 && (
            <p className="text-ink-500 dark:text-ink-400">Aucun poste ouvert pour le moment. N'hésitez pas à nous envoyer votre candidature spontanée à <a href="mailto:careers@liafrik.com" className="text-brand-600 hover:underline">careers@liafrik.com</a>.</p>
          )}
          {!loading && jobs.map((j) => (
