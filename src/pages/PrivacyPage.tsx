...
export function PrivacyPage() {
  return (
    <FooterPageLayout title="Politique de confidentialité">
      ...
      <section>
        <h2 className="text-xl font-bold text-ink-900">1. Responsable du traitement</h2>
      ...
      <section>
        <h2 className="text-xl font-bold text-ink-900">2. Données collectées</h2>
      ...
      <section>
        <h2 className="text-xl font-bold text-ink-900">3. Finalités du traitement</h2>
      ...
      <section>
        <h2 className="text-xl font-bold text-ink-900">4. Cookies</h2>
      ...
      <section>
        <h2 className="text-xl font-bold text-ink-900">5. Vos droits</h2>
      ...
      <section>
        <h2 className="text-xl font-bold text-ink-900">7. Conservation</h2>
