...
export function PrivacyPage() {
  ...
  return (
    <FooterPageLayout title={t('privacy.title')}>
      ...
      <section>
        <h2 className="text-xl font-medium text-ink-900 dark:text-ink-50">{t('privacy.s2.title')}</h2>
      ...
      <section>
        <h2 className="text-xl font-medium text-ink-900 dark:text-ink-50">{t('privacy.s3.title')}</h2>
        <p>{t('privacy.s3.text')}</p>
      </section>

      <section>
        <h2 className="text-xl font-medium text-ink-900 dark:text-ink-50">{t('privacy.s4.title')}</h2>
      ...
      <section>
        <h2 className="text-xl font-medium text-ink-900 dark:text-ink-50">{t('privacy.s6.title')}</h2>
