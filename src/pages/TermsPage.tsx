...
export function TermsPage() {
  return (
    <FooterPageLayout title="Conditions générales d'utilisation">
      <p className="text-sm text-ink-500">Dernière mise à jour : juillet 2026</p>

      <section>
        <h2 className="text-xl font-bold text-ink-900">1. Objet</h2>
      ...
      <section>
        <h2 className="text-xl font-bold text-ink-900">2. Définitions</h2>
      ...
      <section>
        <h2 className="text-xl font-bold text-ink-900">3. Accès au service</h2>
      ...
      <section>
        <h2 className="text-xl font-bold text-ink-900">4. Abonnements et essai gratuit</h2>
      ...
      <section>
        <h2 className="text-xl font-bold text-ink-900">5. Responsabilités</h2>
      ...
      <section>
        <h2 className="text-xl font-bold text-ink-900">6. Propriété intellectuelle</h2>
      ...
      <section>
        <h2 className="text-xl font-bold text-ink-900">7. Résiliation</h2>
      ...
      <section>
        <h2 className="text-xl font-bold text-ink-900">8. Contact</h2>
